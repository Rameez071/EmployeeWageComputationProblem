...
public class EmployeeWageBuilder {
    ...
    public EmployeeWageBuilder(String company, int empRatePerHr, int numOfWorkDays, int maxHrsPerMonth){
    ...
    public static void main(String args[]) {
        ...
        EmployeeWageBuilder reliance = new EmployeeWageBuilder("Reliance", 25, 5, 15);
        dMart.totalEmpWage();
